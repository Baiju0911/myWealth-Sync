...
export type AppView = 'summary' | 'banks' | 'accounts' | 'upload' | 'credentials' | 'schemas'| 'ingestDynamic'| 'ingestDynamicBulk'|'AccountingHeaders'|'StagingQueueEvaluator'|'Ledgerdashboard';  
