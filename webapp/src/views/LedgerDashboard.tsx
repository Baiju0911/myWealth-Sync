...
import { 
  ...
  ArrowUpRight,
  ArrowDownRight,
  Zap // 👈 Added Zap Icon for the Smart Sweep Hub Button
} from 'lucide-react';
import { 
  BarChart, 
  Bar, 
...
>
  ...
  <span>⚡ Node 99 Rule Sweep Hub</span>
                ...
                <span className="text-xs font-mono bg-zinc-950 border border-zinc-800 px-3 py-1.5 rounded-lg text-cyan-400 font-bold whitespace-nowrap">
